...
class ListSchedulePage extends StatefulWidget {
  final int houseId;
  const ListSchedulePage({Key? key, required this.houseId}) : super(key: key);
...
class _ListSchedulePageState extends State<ListSchedulePage>
  ...
  void initState() {
    super.initState();
    viewModel.getEvents(widget.houseId);
  }
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    H2Accordion(
                      title: 'Agenda ${state.listEvents?.name ?? ''}',
                      subtitle:
                          'clique para saber mais detalhes de cada torneio',
                      icon:
                                ...
                                (eventDetail) => Column(
                                  children: [
                                    CardImage.schedule(
                                      ...
                                      backgroundImage: eventDetail.banner,
                                    ),
