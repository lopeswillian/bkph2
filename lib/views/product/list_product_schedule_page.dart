...
class ListProductSchedulePage extends StatefulWidget {
  const ListProductSchedulePage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _ListProductSchedulePageState createState() => _ListProductSchedulePageState();
}

class _ListProductSchedulePageState extends State<ListProductSchedulePage>
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          ...state.accordionProductsSchedule
              .map(
                (accordion) => Column(
                  children: [
                    H2Accordion(
