...
class VerifyFinishPage extends StatefulWidget {
  const VerifyFinishPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _VerifyFinishPageState createState() => _VerifyFinishPageState();
}

class _VerifyFinishPageState extends State<VerifyFinishPage> {
            ...
            child: IntrinsicHeight(
              child: Container(
                ...
                child: NextWidget(
                  title: 'Finalizar',
                  action: () async {
                    await loginViewModel.loadCustomer();
