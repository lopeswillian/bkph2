...
class CompanyAccountPageArguments{
  final bool isClient;
  CompanyAccountPageArguments({required this.isClient});
}

class CompanyAccountPage extends StatefulWidget {
  final CompanyAccountPageArguments arguments;
  const CompanyAccountPage({Key? key, required this.arguments}) : super(key: key);
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'O ${widget.arguments.isClient ? 'cliente':'fornecedor'} é uma pessoa física ou jurídica?',
                              style: TextStyle(
                            ...
                            CustomTile(
                              action: () {
                                Nav.pushNamed(
                                  BaseAppModuleRouting.companyPersonDocPage,
                                  arguments: CompanyPersonDocPageArguments(isClient: widget.arguments.isClient)
                                );
                              },
                              svgItem:
                            ...
                            CustomTile(
                              action: () {
                                Nav.pushNamed(
                                  BaseAppModuleRouting.companyDocPage,
                                  arguments: CompanyDocPageArguments(isClient: widget.arguments.isClient)
                                );
                              },
                              svgItem:
