...
class CompanyDocPageArguments {
  final bool isClient;

  CompanyDocPageArguments({required this.isClient});
}

class CompanyDocPage extends StatefulWidget {
  final CompanyDocPageArguments arguments;
  const CompanyDocPage({Key? key, required this.arguments}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CompanyDocPageState createState() => _CompanyDocPageState();
}

class _CompanyDocPageState extends State<CompanyDocPage>
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Informe o CNPJ do seu ${widget.arguments.isClient ? 'cliente' : 'fornecedor'}',
                              style: TextStyle(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomTextFormField(
                                    ...
                                    initialValue:
                                        state.bcoCnpjInfo!.businessName,
                                    enabled: false,
                                    contentPadding: EdgeInsets.symmetric(
                                      horizontal: Dimension.sm.width,
                                      vertical: Dimension.sm.width,
                                  ...
                                  CustomTextFormField(
                                    labelText: 'Endereço',
                                    initialValue: state.bcoCnpjInfo!.address,
                                    enabled: false,
                                    contentPadding: EdgeInsets.symmetric(
                                      horizontal: Dimension.sm.width,
                                      vertical: Dimension.sm.width,
                                  ...
                                  CustomTile(
                                    ...
                                    title: state
                                        .selectedCustomerCompany!.businessName,
                                    secondSubTitle:
                                        state.selectedCustomerCompany!.cnpj,
                                        ...
                                        child: RichText(
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              const TextSpan(
                                                text:
                                                    'Declaro que a pessoa jurídica indicada é um ',
                                              ),
                                              TextSpan(
                    ...
                    child: NextWidget(
                      ...
                      action: () {
                        Nav.pushNamed(
                          ...
                          arguments: CompanyPaymentThirdPageArguments(
