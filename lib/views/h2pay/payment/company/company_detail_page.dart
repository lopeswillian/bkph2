                          ...
                          children: [
                            ...
                            CustomTile(
                              ...
                              title: paymentViewModel
                                  .state.selectedCustomerCompany!.businessName,
                              secondSubTitle: paymentViewModel
                            ...
                            CustomTextFormField(
                              ...
                              initialValue: paymentViewModel
                                  .state.selectedCustomerCompany!.address,
                              enabled: false,
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: Dimension.sm.width,
                                vertical: Dimension.sm.width,
                            ...
                            CustomTextFormField(
                              labelText: 'CPF',
                              initialValue: loginViewModel.state.user!.cpf,
                              enabled: false,
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: Dimension.sm.width,
                                vertical: Dimension.sm.width,
                            ...
                            CustomTextFormField(
                              ...
                              initialValue: loginViewModel.state.user!.name,
                              enabled: false,
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: Dimension.sm.width,
                                vertical: Dimension.sm.width,
                ...
                child: IntrinsicHeight(
                  child: Container(
                    ...
                    child: NextWidget(
                      ...
                      action: () {
                        Nav.pushNamed(
                          BaseAppModuleRouting.paymentTermPage,
                        );
                      },
                    ),
                  ),
