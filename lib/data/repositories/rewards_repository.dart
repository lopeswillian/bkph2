...
class RewardsRepository implements IRewardsRepository {
  ...
  @override
  Future<Either<H2Failure, List<RewardsAccordionCategory>>> getRewardsAccordionCategory() async {
    try {
   ...
   @override
  Future<Either<H2Failure, RewardsCategory>> getRewardsCategoryDetail(int id) async {
    try {
