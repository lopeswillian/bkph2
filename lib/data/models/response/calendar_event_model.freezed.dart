...
mixin _$CalendarEventModel {
  ...
  String get fullDate => throw _privateConstructorUsedError;
...
abstract class $CalendarEventModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      String title,
      String banner,
      @JsonKey(name: 'full_date') String fullDate,
...
class _$CalendarEventModelCopyWithImpl<$Res, $Val extends CalendarEventModel>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      rebuy: null == rebuy
          ? _value.rebuy
          : rebuy // ignore: cast_nullable_to_non_nullable
              as double,
      addon: null == addon
          ? _value.addon
...
/// @nodoc
@JsonSerializable()
class _$_CalendarEventModel extends _CalendarEventModel {
  _$_CalendarEventModel(
      {required this.id,
      required this.title,
      required this.banner,
      @JsonKey(name: 'full_date') required this.fullDate,
  ...
  factory _$_CalendarEventModel.fromJson(Map<String, dynamic> json) =>
      _$$_CalendarEventModelFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.fullDate, fullDate) ||
  ...
  Map<String, dynamic> toJson() {
    return _$$_CalendarEventModelToJson(
      this,
    );
  }
}
...
abstract class _CalendarEventModel extends CalendarEventModel {
  ...
  factory _CalendarEventModel.fromJson(Map<String, dynamic> json) =
      _$_CalendarEventModel.fromJson;
