...
class _$_RegisterParams implements _RegisterParams {
  ...
  @override
  String toString() {
    return 'RegisterParams(nationality: $nationality, name: $name, nickname: $nickname, gender: $gender, email: $email, cpf: $cpf, cellphone: $cellphone, birthdate: $birthdate, zipcode: $zipcode, address: $address, number: $number, complement: $complement, district: $district, state: $state, city: $city, password: $password, passwordConfirmation: $passwordConfirmation)';
  }
